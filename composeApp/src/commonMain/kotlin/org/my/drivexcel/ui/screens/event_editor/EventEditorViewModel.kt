...
@Serializable
sealed interface EventEditorViewModelEventId {
    @Serializable

    data object NONE : EventEditorViewModelEventId

    @Serializable
    data class EventId(val eventId: String) : EventEditorViewModelEventId
}