package org.my.drivexcel.v4.ui.screens.events
...
import org.my.drivexcel.v4.ui.components.AlertDialogComponent
import org.my.drivexcel.v4.ui.screens.events.components.EventListItemComponent

@Composable
fun EventsRoute(
    viewModel: EventsViewModel = koinViewModel(),
    onEventPressed: (id: String) -> Unit,
    onCreateEvent: () -> Unit,
    ...
    LaunchedEffect(viewModel) {
        viewModel.events.collect { event ->
            when (event) {
                is EventsUiEvent.UpdateEvent -> onUpdateEvent(event.id)
                EventsUiEvent.CreateEvent -> onCreateEvent()
                is EventsUiEvent.EventPressed -> onEventPressed(event.id)
            }
        }
    }
